...
kb_subscribe_to_newsletter.add_text_button(
    "Подписаться на рассылку", color=ButtonColor.PRIMARY
)
kb_subscribe_to_newsletter.add_row()
kb_subscribe_to_newsletter.add_text_button("назад", color=ButtonColor.NEGATIVE)
kb_unsubscribe_from_mailing_list.add_text_button(
    "Отписаться от рассылки", color=ButtonColor.PRIMARY
)
